...
<head>
    ...
    <link rel="shortcut icon" href="<?= BASE_URL ?>/assets/logos/logo.png" type="image/x-icon">
...
<body class="font-sans">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-2">Choisissez votre véhicule</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-2">Véhicule garanti!</h3>
    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-center items-center gap-12 opacity-60">
                ...
                <img src="<?= BASE_URL ?>/assets/nissan.png" alt="Nissan" class="h-8 grayscale">
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <img src="https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=800" alt="Voiture" class="ml-40 w-[400px] h-[400px] rounded-lg shadow-xl">
                </div>
                <div>
    ...
    <section class="py-16 bg-blue-50">
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-2xl mx-auto">
                <img src="<?= BASE_URL ?>/assets/Carte_du_Maroc.png" alt="Carte du Maroc" class="w-full h-auto">
            </div>
        </div>
    </section>
